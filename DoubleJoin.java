 ...
 * 
 */
public class DoubleJoin extends Configured implements Tool{
   static final Logger sLogger = Logger.getLogger(DoubleJoin.class);
   ...
   public boolean joinStep(String input, String output, int numReducer) throws Exception{
      ...
      job.setJarByClass(DoubleJoin.class);
   ...
   public static void main(String[] args) throws Exception {
      int exitCode = ToolRunner.run(new DoubleJoin(), args);
